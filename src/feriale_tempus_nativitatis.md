...
| event_key                 | name                             |
| ------------------------- | -------------------------------- |
| ChristmasWeekdayDec29     | Dies Quintus Octavæ Nativitatis  |
| ChristmasWeekdayDec30     | Dies Sextus Octavæ Nativitatis   |
| ChristmasWeekdayDec31     | Dies Septimus Octavæ Nativitatis |
| ChristmasWeekdayJan2      | %s temporis Nativitatis          |
| ChristmasWeekdayJan3      | %s temporis Nativitatis          |
| ChristmasWeekdayJan4      | %s temporis Nativitatis          |
| ChristmasWeekdayJan5      | %s temporis Nativitatis          |
